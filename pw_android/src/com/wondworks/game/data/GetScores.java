...
public class GetScores {
	...
	private static String url_all_scores = "http://10.44.68.64:8888/pw_php/data/get_all_scores.php";
	...
	public GetScores() throws Throwable, Throwable {
		
		// Loading scores in Background Thread
		new LoadAllScores().execute().get();
		
	}
	
	public ArrayList<HashMap<String, String>> getScoresList() {
